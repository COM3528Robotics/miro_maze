...
# local paths
export GAZEBO_MODEL_PATH=./../../mdk-200720/sim/models:${GAZEBO_MODEL_PATH}
export GAZEBO_RESOURCE_PATH=./../../mdk-200720/sim:${GAZEBO_RESOURCE_PATH}
...
# launch
gazebo ../../mdk-200720/sim/worlds/$WORLD.world $@
